...
namespace AccDatos
{
    public class AccesoDatos
    {
        ...
        //internal int SP_UpdateActor(string nombre, string apellido, string mail, string usuario, string v)
        //{
        ...
        public int SP_AñadirUsuarios(string nombre, string apellido, string mail, string usuario, string pass) // Este se puede usar para el registro pero hay que quitar y añadir lo que necesitamos
        {
            try
            {
                EstablecerConexion();
        ...
        // INICIO SESION
        public int SP_Login(string usuario, string pass) // Añadir los datos que necesitamos y eliminar los que no
        {
            try
            {
                EstablecerConexion();
